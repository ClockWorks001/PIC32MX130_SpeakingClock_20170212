...
#define RTCC_alarmON alarm.cFlagON
#define RTCC_alarmOFF (alarm.cFlagON == vFLAG_OFF)

void vRTCC_chimeTurnON(void);
void vRTCC_chimeTurnOFF(void);
#define RTCC_chimeON chime.cFlagON
#define RTCC_chimeOFF (chime.cFlagON == vFLAG_OFF)
